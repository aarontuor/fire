...
from util import confusion, confusion_matrix, print_results
...
# folds = StratifiedKFold(split_labels, n_folds=5, random_state=5)
...
# rf_random.fit(np.concatenate([soil_class, coverage_class, ecoregions, all_data[:, partitions['d2']]], axis=1), full_label)
